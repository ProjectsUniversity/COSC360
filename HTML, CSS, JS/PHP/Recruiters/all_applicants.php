...
try {
    // Fetch all applications for all jobs for this employer.
        ...
        <table class="table table-bordered" id="applicationsTable">
            ...
            <tbody>
                <?php foreach ($applications as $app): 
                    // Default status is "pending" if null.
                ...
                <tr id="row-<?php echo $app['application_id']; ?>">
                    ...
                    <td>
                        <!-- Each button is within a form that uses data attributes.
                             The JS will handle the AJAX update after confirmation. -->
            ...
            form.addEventListener("submit", function(e){
                ...
                .then(data => {
                    ...
                    if (data.error) {
                        ...
                        // Update the status tag in the corresponding row.
